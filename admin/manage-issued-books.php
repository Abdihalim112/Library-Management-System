...
<head>
    ...
    <title>Gollis Library Management System | Manage Issued Books</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a class="hit" href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
