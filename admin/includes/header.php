<div style="  background-image: url('assets/img/banner.png');  background-repeat: no-repeat;" class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            <div  class="navbar-header">
                ...
                <img style="padding-left:710px; image-size:10px;" src="assets/img/logo.png?v=<?php echo time(); ?>" />
 ...
 <li>
                           ...
                           <li>
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Registeration <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="reg-students.php">Registered Students</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="signup.php">Register New</a></li>
                                </ul>
                            </li>
