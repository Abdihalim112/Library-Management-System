...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,Author=:author, where id=:bookid";
...
<head>
    ...
    <title>Gollis Library Management System | Edit Book</title>
...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT tblbooks.BookName,tblcategory.CategoryName,tblcategory.id as cid,tblbooks.Author,tblbooks.ISBNNumber,tblbooks.id as bookid,tblbooks.bookImage from  tblbooks join tblcategory on tblcategory.id=tblbooks.CatId  where tblbooks.id=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
